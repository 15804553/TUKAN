...

{
    ...
    private static readonly SolidColorBrush DayNumberFg =
...

    {
...

        {
            ...
            Binding = new Binding(nameof(GrafikRowViewModel.ImieNazwisko)),
            ...
            ElementStyle = CreateNameCellStyle()
...

    {
        ...
        var hideNormal = new DataTrigger { Binding = new Binding(nameof(GrafikRowViewModel.IsSummaryRow)), Value = true };
        ...
        // ── Komórka sumaryczna (Wolne miejsca / Kierowcy / Nurkowie) ────────
...

    {
        ...
        textFactory.SetBinding(TextBlock.TextProperty, new Binding($"[{day}]") { Converter = WsCellTextConverter.Instance });
...

    {
        ...
        var showSummary = new DataTrigger { Binding = new Binding(nameof(GrafikRowViewModel.IsSummaryRow)), Value = true };
    ...
    private static Style CreateNameCellStyle()

    {
        ...
        nurekFg.Setters.Add(new Setter(TextBlock.ForegroundProperty,
            new Binding(nameof(GrafikRowViewModel.RowForeground))));
        style.Triggers.Add(nurekFg);
