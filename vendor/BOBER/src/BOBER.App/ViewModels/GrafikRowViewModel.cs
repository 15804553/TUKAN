...
public sealed class GrafikRowViewModel : INotifyPropertyChanged
{
    ...
    /// <summary>Liczba linii wiersza sumarycznego (Wolne miejsca + definicje).</summary>
    public int SummaryLineCount { get; init; }
    /// <summary>Wiersz ikon notatek pod sumą — komórki zawierają treść notatki dnia.</summary>
