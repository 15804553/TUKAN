...
/// <summary>
/// Dopisuje typ uprawnienia „Dowodzenie przy akcji” do istniejących baz (seed dotyczy tylko nowych).
/// </summary>
internal static class DowodzeniePrzyAkcjiUprawnienieMigration
{
    private const string Nazwa = "Dowodzenie przy akcji";
