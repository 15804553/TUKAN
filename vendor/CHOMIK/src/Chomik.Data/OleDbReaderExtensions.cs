...
internal static class OleDbReaderExtensions
{
    ...
    public static decimal? GetNullableFieldDecimal(this DbDataReader reader, int ordinal) =>
        reader.IsDBNull(ordinal) ? null : Convert.ToDecimal(reader.GetValue(ordinal));

    public static DateTime GetFieldDateTime(this DbDataReader reader, int ordinal) =>
