...
/// Preferuje katalog oznaczeń (most TUKAN); legacy tylko gdy most nieobsłużony.
/// </summary>
public static class BoberTypWpisuMapper
{
    /// <summary>
    /// Zwraca typ nieobecności albo null, gdy osoba jest dostępna (brak wpisu, „?”, WPracy).
    /// </summary>
    ...
    public static string BazowyKod(string? typWpisu) =>
        string.IsNullOrWhiteSpace(typWpisu) ? string.Empty : typWpisu.Trim();
